		...
		while (slotTime < this.maxTime) {
			...
			axisHtml =
				'<td class="fc-axis fc-time ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '>' +
					...
					//added by CB 11/1/2014 in order to make "normal" time intervals appear
					//https://code.google.com/p/fullcalendar/issues/detail?id=946#makechanges
			...
			html +=
				'<tr ' + (!minutes ? '' : 'class="fc-minor"') + '>' +
					...
					//Added by CB:1/18 - added two more columns
...
$.extend(AgendaView.prototype, {
	...
	renderHtml: function() {
		console.log("renderHTML - AgendaView");
		console.log("widgetHeaderClass: " + this.widgetHeaderClass);
		console.log("headHTML: " + this.timeGrid.headHtml());
		//console.log("dayGrid: " + this.dayGrid);
				...
				'<tbody>' +
					'<tr>' +
						'<td class="' + this.widgetContentClass + '">' +
							...
							//CB - may need to add rows here for employee names
	...
	dayIntroHtml: function() {
		return '' +
			...
			//Added by CB
			//Added a column for each employee name
			'<td class=\'employee_col\'>Kieron</td>' + 
			'<td class=\'employee_col\'>Tiara</td>' + 
			'<td class=\'employee_col\'>Doug</td>' + 
			'<td class=\'employee_col\'>Melvin</td>' + 
			'<td class=\'employee_col\'>Jackie</td>';
	},
