$(document).ready(function(){
	...
	var events = [
		{start_date:"01/29/2015 11:00", end_date:"01/29/2015 11:30", text:"Haircut", unit_id:"1"},
	    {start_date:"01/29/2015 09:00", end_date:"01/29/2015 09:15", text:"Color", color:"#F58839", unit_id:"5"},
	    {start_date:"01/29/2015 13:00", end_date:"01/29/2015 14:00", text:"Haircut", unit_id:"3"}
	];
	...
	*/
	...
	$('.make_appt_btn').click(function(event){ 
		...
		var appt = [
			{start_date:apptDateIn + " " + startTime, end_date:apptDateIn + " " + endTime, color:apptColor, text:apptTitle, unit_id:unitID}
