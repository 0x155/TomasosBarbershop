...
$(document).ready(function(){
	...
	*/
	...
	/*
	Display the customer's phone number in the title of the quick-info box.
	...
	*/
	...
	scheduler.attachEvent("onEventCollision", function (ev, evs){
  	...
  	scheduler.attachEvent("onEventAdded", function(id,ev){
	    ...
	    //message below is not displaying for some reason
	...
	scheduler.attachEvent("onEventIdChange", function(old_id,new_id){
    	console.log("EventID changed. OLD ID: " + old_id + ",  New ID: " + new_id);
	});
...
/*
	function error_func(node){
		console.log("--ERROR--");
		console.log(node.getAttribute("type"));
		console.log(node.getAttribute("sid"));
		console.log(node.getAttribute("tid"));
		console.log(node.firstChild.data);
		console.log("------");
		return true;
	}
	function delete_func(node){
		console.log("--DELETED--");
		console.log(node.getAttribute("type"));
		console.log(node.getAttribute("sid"));
		console.log(node.getAttribute("tid"));
	...
	dp.defineAction("error", error_func);
	dp.defineAction("deleted", delete_func);
*/
...
function save_form(){
	...
	//console.log("formatted start time: " + frmtedStartTime);
	//console.log("formatted end time: " + frmtedEndTime + ", typeof: " + typeof(frmtedStartTime));
	...
	*/
	...
	//displays a message in the top right corner for a few seconds, then goes away
	dhtmlx.message("Appointment Updated!");
...
function makeAppointment(){
	...
	if(fieldsLength){
		...
		*/
		//To-DO: if( (startTime < "09:00") || (endTime > "20:00") )
		if(startTime < "09:00"){
			valid = false;
			$("#make_appt_bad_hrs_msg").show();
			//show dhtml error message
		}
		else{
		...
		if(valid){
			...
			getApptIDs(customerName, employeeName, apptTitle, function(ret){
				...
				//console.log("callback from getApptIDs: " + employeeUnitID + ", " +
				...
				//console.log("return from addEventToCalendar");
...
function editCustInfo(){
	...
	*/
	...
	//$(".edit-cust-info-field").toggleClass("edit-cust-field-selected");
