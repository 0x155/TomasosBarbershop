...
$(document).ready(function(){
	...
	*/
	...
	//Anytime the background of a modal is clicked, close the modal
...
function showSettings() {
	...
	getAllEmployeeNames(function(employees) {
		employees.forEach(function(employee) {
			console.log("Name: " + employee.Name + ", Unit: " + employee.Unit_ID);
			if (employee.Unit_ID) {
...
function closeSettings() {
	var doc = document;
	var settingsWindow = doc.getElementById("modal_wrapper_settings");
