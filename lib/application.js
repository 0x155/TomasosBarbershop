$(document).ready(function(){
	...
	*/
	...
	//This is the datepicker for the appointment
	//This is displayed on the main screen
	$('.datepicker').datepicker({
		format:"mm/dd",
		todayBtn:"linked",
		autoclose:true,
	...
	//This datepicker is used to select a customer's birthday when
	//adding a customer to the database
	$('#new_cust_birthday').datepicker({
		//autoclose:true
	});
	...
	$('.calendar').fullCalendar({
		...
		/*
		Put events to be displayed here in the "constructor" for the calendar
		events: [
			{
				title: 'Haircut',
	...
	$("#unavailable-all-day").change(function(){
		...
		else if(!$('#unavailable-all-day').prop('checked')) {
	...
	$('.make_appt_btn').click(function(event){
		...
		*/
		...
		eventData = {
			...
			color: apptColor
			//can add custom fields here if need be
		};
