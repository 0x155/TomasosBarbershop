<?php
	...
	*/
	...
	//error_log("Hi from get_customer_history.php: " . $customerName . " Start: " . $startRow . " Num: " . $numRows);

	//Num rows and start row??
	try{
		//$customerHistory = Customer::getFullCustomerHistory($customerName, $startRow, $numRows);
